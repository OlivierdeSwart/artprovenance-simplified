...
import { Globe, Shield, Banknote, Lock, FileStack } from 'lucide-react';
...
const features = [
  ...
  {
    id: 4,
    title: "Secure & Private Ownership",
    description: "Maintain full privacy with our fully compliant system, with optional custodial verification for added security.",
    icon: Lock,
